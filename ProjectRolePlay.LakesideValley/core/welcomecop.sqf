...
_imag  = "<img image='textures' size='10' align='center'/>"; _text = format["<br/><t color='#C5B6B5' size='1.8' align='center'>Welcome %1 to ProjectRolePlay</t><br/><br/>",ProfileName];  
...
_role1 = "Welcome to";
_role1names = ["ProjectRolePlay"];       //Add your texts here!
_role2 = "Always be on TS";
_role2names = ["prorp.ts.nfoservers.com"];
_role3 = "Rules";
